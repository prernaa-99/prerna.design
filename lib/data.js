export const PRERNA_BIO =
  "Product designer working at the seam of brand, product, and motion. Currently building products at Times Internet, based in Bangalore.";
...
export const PROJECTS = [
  {
    ...
    year: "2024",
    title: "STAGE",
    headline: "Scaling discovery for the next million users.",
    highlight: "next million users.",
    body: "Transformed STAGE's content classification approach by introducing a culturally rooted tagging system that mirrors regional audience vocabulary and improves content discoverability.",
    role: "Product designer",
    accent: "#2e5c8a",
    href: "/case-stage",
    cover: "/images/stage/case1-cover.webp",
    coverScale: 0.82, // case 1 composite reads larger, scale down to match case 2
  },
  {
    n: "02",
    year: "2024",
    title: "STAGE · Platter",
    headline: "Turning static into intent.",
    highlight: "intent.",
    body: "Converted STAGE's homepage poster from a static banner into an interactive preview experience that increases engagement and drives content discovery.",
    role: "Product designer",
    accent: "#3a6ea5",
    href: "/case-stage-platter",
    cover: "/images/stage/case2-cover.webp",
  },
];
...
export const EXPERIENCE = [
  {
    ...
    org: "Times Internet",
    note: "Made the switch in 2026 to Times Internet as an associate product designer.",
  },
  {
    period: "2023, 2026",
    role: "Product Designer",
    org: "STAGE",
    note: "Converted from intern to full-time the same year, owned content discovery and the homepage redesign (see the case studies above).",
  },
  {
    period: "2023",
    role: "Product Design Intern",
    org: "STAGE",
    note: "Started at STAGE as a product design intern.",
  },
];
